...
<html lang="en">
<head>
    <title><?php echo $username . 'Selled Books'; ?></title>
...
<div class="col-sm-2">
    <div class="list-group">
        ...
        <a href="/uadmin/usedsel.html" class="list-group-item">
            ...
            <p class="list-group-item-text">Order Info.</p>
        </a>
        <a href="/uadmin/order.html" class="list-group-item">
            <h4 class="list-group-item-heading">Pruchase History</h4>
