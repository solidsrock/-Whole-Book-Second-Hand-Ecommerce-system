...
<div class="col-sm-2">
  ...
  <h4 class="list-group-item-heading">Home</h4>
        ...
        <a href="/admin/usedbook.html" class="list-group-item active">
...
<form method="post" action="http://localhost/admin/usedbook.html">
            <label>used book id</label><input type="text" name="searchid" placeholder="please input the used book ID">
            <input type="submit" value="search" />
        </form>
            <div class="panel panel-default">
                <!-- Default panel contents -->
                <div class="panel-heading">used books info</div>
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    for($cnt=0;$cnt<count($oldbooklist);$cnt++) {
                        //echo $newlist[$cnt]['title'];

                        echo "<tr>";
                        echo "<td>".$cnt."</td>";
                        echo "<td>".$oldbooklist[$cnt]['title']."</td>";
                        $bookprice = (double)$oldbooklist[$cnt]['price']/(double)100;
                        echo "<td>".$bookprice."</td>";
                        echo "<td>".$oldbooklist[$cnt]['author']."</td>";
                        echo "<td>".$oldbooklist[$cnt]['contributor']."</td>";
                        echo "</tr>";
                    }
                    ?>
                    </tbody>
