...
<div class="col-sm-2">
    <div class="list-group">
        ...
        <a href="/admin/order.html" class="list-group-item active">
...
<div class="col-sm-8" style="border-left: 1px dashed #C7C7C7">
    ...
    <form method="post" action="http://localhost/admin/order.html">
            <label>order-id</label><input type="text" name="searchid" placeholder="please input the order ID">
            ...
            <div class="panel panel-default">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    for($cnt=0;$cnt<count($orderlist);$cnt++) {
                        //echo $newlist[$cnt]['title'];

                        echo "<tr>";
                        echo "<td>".$cnt."</td>";
                        echo "<td>".$orderlist[$cnt]['ordtime']."</td>";
                        echo "<td>".$orderlist[$cnt]['itemid']."</td>";
                        echo "<td>".$orderlist[$cnt]['username']."</td>";
                        echo "</tr>";
                    }
                ?>
                    </tbody>
